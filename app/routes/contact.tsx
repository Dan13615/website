		...
		<div>
			...
			<PageLayout bg_color="brown">
				<div className="container px-4">
					<div className="text-center mb-8">
						<h2 className="textStyle-title2 font-bold text-white mb-4">Envoyez-nous un message</h2>
						<p className="textStyle-subtitle2 text-white">Une question, une suggestion ou simplement envie de nous dire bonjour ? N'hésitez pas à nous contacter, nous vous répondrons dans les plus brefs délais.</p>
					</div>
					<ContactForm />
				</div>
			</PageLayout>
			<PageLayout bg_color="green">
				<div className="container mx-auto">
					<div className="text-center mb-8">
						<h2 className="textStyle-title2 font-bold text-white mb-4">Où nous trouver</h2>
						<p className="textStyle-subtitle2 text-white mb-8">Venez nous rendre visite dans notre restaurant !</p>
					</div>
				...
				<div className="container mx-auto px-4 mt-8 pt-16">
					<div className="text-center">
						<p className="textStyle-subtitle text-white mb-8">Pour toute question, suggestion ou demande particulière, n'hésitez pas à nous contacter via le formulaire ci-dessus ou par téléphone.</p>
						...
						<p className="textStyle-subtitle2 text-white">Nous sommes ouverts tout les jours, de 9h à 23h.</p>
					</div>
				</div>
			</PageLayout>
		</div>
